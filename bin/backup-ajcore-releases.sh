...
mkdir -p "/Users/sandip/Projects/ajcore/releases/ajcore-backups"

tar -czf "/Users/sandip/Projects/ajcore/releases/ajcore-backups/ajcore-backup-$(date +%Y%m%d-%H%M%S).tar.gz" \
  ajcore.php \
